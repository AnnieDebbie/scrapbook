<template>
  ...
  >
    ...
    >
      <router-link to="/memories" class="fixed bottom-0 left-0 z-50">
        <div class="relative w-20 h-20">
          <div
            class="absolute bottom-0 left-0 w-20 h-20 bg-[#F5EED8] rounded-tr-3xl shadow-lg group-hover:bg-yellow-300 transition-colors duration-300"
          ></div>
          <span
